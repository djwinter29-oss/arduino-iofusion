...
COVERAGE_FILTER=${COVERAGE_FILTER:-lib/IOFusion/src/(analog_sampler|digital_input_monitor|encoder_generator)\.cpp|apps/reference_firmware/src/firmware_cli.cpp}
